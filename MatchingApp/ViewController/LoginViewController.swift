...
class LoginViewController: UIViewController {
    ...
    private let loginButton = RegisterButton(text: "Check")
    private let dontHaveAccountButton = UIButton(type: .system).createAboutAccount(text: "If you don't have ID Please Click Here.")
    ...
    private func setupLayout() {
        ...
        dontHaveAccountButton.anchor(top: baseStackView.bottomAnchor, centerX: view.centerXAnchor,
                                        topPadding: 20)
    }
